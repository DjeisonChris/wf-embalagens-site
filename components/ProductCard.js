...
// Função para transformar texto em slug (ex: "Bandejas de Isopor" -> "bandejas-de-isopor")
const slugify = (text) => {
  if (!text) return ''; // Adiciona uma verificação de segurança
...
const ProductCard = ({ product }) => {
  ...
  // Garante que temos um link válido mesmo que o slug esteja em falta na planilha
  const detailUrl = `/produto/${categorySlug}/${product.slug}`;
