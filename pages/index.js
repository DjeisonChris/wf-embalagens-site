...
// ... (Sua função getStaticProps continua a mesma, não precisa mudar)
...
export default function Home({ categories, featuredProducts }) {
  return (
    // Removi o padding da main para o conteúdo ir até as bordas
    <main className="flex min-h-screen flex-col items-center bg-gray-50">
      
      {/* (FUTURO BANNER PRINCIPAL AQUI) */}

      {/* Seção de Categorias com layout corrigido */}
      ...
      {/* Seção de Produtos em Destaque com layout corrigido */}
      <section className="w-full max-w-6xl py-12 px-4">
      ...
      {/* (OUTRAS SEÇÕES DA PÁGINA INICIAL AQUI) */}
    </main>
  );
}